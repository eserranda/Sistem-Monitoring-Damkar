...
@section('content')
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="card">
                <h5 class="card-header">Edit Data Posko Damkar</h5>
                <div class="card-body">
                    <form action="" method="POST" id="form_update_data_damkar" novalidate>
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="id_damkar" name="id_damkar" required>
                                <option value="{{ $dataDamkar->id_damkar }}">{{ $dataDamkar->nama }}</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" class="form-control" id="id" name="id"
                                value="{{ $dataDamkar->id }}" required readonly />

                            <input type="text" class="form-control" id="nama" name="nama"
                                value="{{ $dataDamkar->nama }}" placeholder="Nama Posko" required readonly />
                            <div class="invalid-feedback"> </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-lg-5 mb-0">
                                ...
                                <input type="text" id="latitude" name="latitude" class="form-control"
                                    placeholder="Latitude" value="{{ $dataDamkar->latitude }}" required />
                                <div class="invalid-feedback"> </div>
                            ...
                            <div class="mb-3 col-lg-5 mb-0">
                                ...
                                <input type="text" id="longitude" name="longitude" class="form-control"
                                    placeholder="Longitude" value="{{ $dataDamkar->longitude }}" required />
                                <div class="invalid-feedback"> </div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="alamat" name="alamat" rows="2" value="{{ $dataDamkar->alamat }}" required> {{ $dataDamkar->alamat }} </textarea>
                            <div class="invalid-feedback"> </div>
                        </div>
    ...
    @push('script')
        <script>
            ...
            document.getElementById('form_update_data_damkar').addEventListener('submit', async function(event) {
                event.preventDefault();
                try {
                    const csrfToken = document.querySelector('meta[name="csrf-token"]').content;
                    const response = await fetch('{{ route('damkar.update') }}', {
                        method: 'POST',
